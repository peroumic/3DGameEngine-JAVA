 ...
 * lines (v for vertices, vt for textures, vn for normals, and f for faces(which define what parameters correspond
 * with each other based on indexes)). It is then loaded into correct arrays, which are forwarded into models.
 *
